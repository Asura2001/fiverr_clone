<header>
    <div class="container-fluid">
        <div class="row">
            <div class="col">
                <nav class="navbar navbar-expand-lg fw-bold">
                    <div class="container-fluid">
                        <a class="navbar-brand mb-lg-1 m-md-auto ps-md-5 ps-lg-0 pe-lg-5" href="./index.php">
                            <img src="./assets/images/icons8-fiverr-50.png" alt="fiver-logo">
                        </a>
                        <button class="navbar-toggler m-1 mt-lg-3 text-end" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <ul class="navbar-nav mt-lg-3 mb-1">
                                <li class="nav-item">
        ...
        <div class="row pt-1 border-top d-none d-lg-block">
            <div class="col">
                <ul class="nav gig">
                    <li class="nav-item">
                        <a class="nav-link text-muted active" aria-current="page">
                            <i class="fa-solid fa-1 text-white bg-dark rounded-pill p-2 me-1"></i>
                            Overview <i class="fa-solid fa-chevron-right ms-3"></i>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-muted ps-2">
                            <i class="fa-solid fa-2 text-white bg-dark rounded-pill p-2 me-1"></i>
                            Pricing <i class="fa-solid fa-chevron-right ms-3"></i>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-muted ps-2">
                            <i class="fa-solid fa-3 text-white bg-dark rounded-pill p-2 me-1"></i>
                            Description & FAQ <i class="fa-solid fa-chevron-right ms-3"></i>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-muted ps-2">
                            <i class="fa-solid fa-4 text-white bg-dark rounded-pill p-2 me-1"></i>
                            Requirements <i class="fa-solid fa-chevron-right ms-3"></i>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-muted ps-2">
                            <i class="fa-solid fa-5 text-white bg-dark rounded-pill p-2 me-1"></i>
                            Gallery <i class="fa-solid fa-chevron-right ms-3"></i>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-muted ps-2">
                            <i class="fa-solid fa-6 text-white bg-dark rounded-pill p-2 me-1"></i> Publish
                        </a>
                    </li>
                </ul>
            </div>
