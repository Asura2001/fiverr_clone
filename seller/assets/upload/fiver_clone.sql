...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 16, 2023 at 01:02 PM
...
(1, 1, 'I will make you a website from scratch', 'Software Development', 'Website Development', 'I can make you want a website that looks professional. \r\nI can also include as many functionalities as you need it to have as long as it does not exceed the number of functionalities I offer.\r\nI can make it responsive.\r\nI can also add a stripe payment sys', 'no'),
...
INSERT INTO `orders` (`id`, `user_id`, `gig_id`, `package_type`, `quantity`, `price`, `status`, `dated`) VALUES
(1, 1, 1, 'basic', '1', '80', 'Paid', '2023-10-13 01:17:14'),
